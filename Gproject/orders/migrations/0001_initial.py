# Generated by Django 6.0 on 2025-12-12 09:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.IntegerField(choices=[(2, 'order_processed'), (3, 'order_processed'), (2, 'order_processed')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='added_carts', to='products.product')),
            ],
        ),
    ]
